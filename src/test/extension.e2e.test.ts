...
describe("Colab Extension", function () {
  ...
  before(async () => {
    ...
    // Create a notebook that we can execute. Note that it's created with a
    // single code cell by default.
  ...
  it("executes the notebook", async () => {
    ...
    // Input the test account password. Note that we wait for the page to settle
